    ...
    <Card>
      ...
      <Box sx={{ p: [2, 3] }}>
                ...
                <InfoIcon
                  tooltip={
                    <Card variant="tooltip" sx={{ width: "240px" }}>
                      Although the ERTY rewards accrue every minute, the value on the UI only updates
        ...
        <Flex variant="layout.actions">
          ...
          <ClaimRewards disabled={!hasGain && !hasReward}>Claim MATIC and ERTY</ClaimRewards>
        </Flex>

        {hasTrove && (
          <ClaimAndMove disabled={!hasGain}>Claim ERTY and move MATIC to Trove</ClaimAndMove>
        )}
      </Box>
