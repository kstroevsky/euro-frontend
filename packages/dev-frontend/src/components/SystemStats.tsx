...
import { ShortStat } from "./ShortStat";
    ...
    <Card {...{ variant }}>
      ...
      :
        <>
          ...
          <Statistic
            name="Borrowing Fee"
            tooltip="The Borrowing Fee is a one-off fee charged as a percentage of the borrowed amount (in mEUR) and is part of a Trove's debt. The fee varies between 0.5% and 5% depending on mEUR redemption volumes."
          >
          ...
          <Statistic name="mEUR supply" tooltip="The total mEUR minted by the Liquity Protocol.">
            {total.debt.shorten()}
          </Statistic>
          {lusdInStabilityPoolPct && (
            <Statistic
              name="mEUR in Stability Pool"
              tooltip="The total mEUR currently held in the Stability Pool, expressed as an amount and a fraction of the mEUR supply.
            "
            >
          ...
          <Statistic
            name="Staked ERTY"
            tooltip="The total amount of ERTY that is staked for earning fee revenue."
          >
