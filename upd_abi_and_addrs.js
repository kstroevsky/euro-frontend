...
const LIB_ETHERS_PTH = './packages/lib-ethers'
const MAINNET_CFG_FN = '/deployments/default/mainnet.json'
...
var mainnet_cfg_js = fs.readFileSync(LIB_ETHERS_PTH+MAINNET_CFG_FN, 'utf8');
...
fs.writeFileSync( LIB_ETHERS_PTH+MAINNET_CFG_FN, JSON.stringify(mainnet_cfg, null, 2))
